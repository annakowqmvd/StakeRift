 ...
 * This file demonstrates how to integrate Stakerift with a web frontend
 */

// For React/Vue/Angular applications
export class StakeriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new StakeriftClient(provider, contractAddress);
